...
class HelpdeskCardGenerator
{
    ...
    // Ukuran template asli: 1040 × 580 px (landscape)
    private const POSITIONS = [
        'ticket_id' => [
            'x'       => 730,   // X start teks
            'y'       => 68,    // Y baseline teks
            'maxW'    => 240,   // lebar maks sebelum truncate
            'size'    => 18,
            'color'   => 'navy',
            'bold'    => true,
        ],
        ...
        'prioritas' => [
            ...
            'maxW'    => 150,
            'size'    => 13,
            'color'   => 'priority',  // warna dinamis berdasarkan nilai
            'bold'    => true,
        ],
        'waktu_dibuat' => [
            'x'       => 128,
        ...
        'detail' => [
            'x'       => 320,
            'y'       => 193,
            'maxW'    => 690,   // lebar area detail
            'maxH'    => 280,   // tinggi maks area detail
            'size'    => 13,
            'color'   => 'dark',
            'bold'    => false,
            'lineH'   => 21,    // line height
            'wrap'    => true,
        ],
        // Footer kiri bawah: waktu singkat
        'footer_time' => [
            'x'       => 488,
            'y'       => 556,
            'maxW'    => 170,
