...
@section('content')
    <div class="fade-in">
        ...
        <div id="confirm-modal"
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-95 opacity-0"
                id="confirm-content">
                <!-- Header -->
                <div class="p-5 pb-3 border-b border-slate-200 dark:border-slate-700">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-amber-400 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-400/30">
                ...
                <div class="p-5">
                    <div
                        class="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl mb-3">
                ...
                <div class="p-5 pt-3 border-t border-slate-200 dark:border-slate-700 flex items-center gap-3">
                    <button onclick="hideConfirmModal()"
                        class="flex-1 px-4 py-2.5 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-semibold transition-colors">
                        Batal
                    </button>
                    <button onclick="submitRegenerate()"
                        class="flex-1 px-4 py-2.5 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white rounded-xl text-sm font-semibold transition-all shadow-lg shadow-amber-400/30">
                        Ya, Regenerate
                    </button>
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('teachers.qr.download', $teacher) }}"
                        class="flex items-center gap-2 px-4 py-2.5 bg-navy-800 hover:bg-navy-900 text-white rounded-xl text-sm font-semibold transition-all shadow-lg shadow-navy-800/30 icon-click">
                        <i data-lucide="download" class="w-4 h-4"></i>
                        Download
                    </a>
                    <button onclick="showConfirmModal()"
                        class="flex items-center gap-2 px-4 py-2.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-semibold transition-colors icon-click">
                    ...
                    <div class="card p-6 h-full">
                        <div class="flex flex-col items-center justify-center h-full">
                            ...
                            <div class="text-center mb-6">
                                ...
                                @endif
                                <p class="text-[10px] text-slate-400 dark:text-slate-500 font-mono mt-2">ID:
                                    {{ $teacher->formatted_id }}</p>
                            </div>
                            ...
                            <div class="relative p-4 bg-white rounded-xl shadow-lg mb-6">
                                ...
                                @else
                                    <div
                                        class="w-56 h-56 bg-slate-100 dark:bg-slate-700 rounded-lg flex flex-col items-center justify-center">
                                        ...
                                        <button onclick="showConfirmModal()"
                                            class="px-5 py-2 bg-gold-400 hover:bg-gold-500 text-navy-900 rounded-lg text-xs font-semibold transition-colors">
                                            Generate
                                        </button>
                                    </div>
                                @endif
                ...
                <div class="space-y-4">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('attendance.scan') }}"
                                class="group flex flex-col items-center gap-2 p-4 bg-gradient-to-br from-gold-400 to-gold-500 hover:from-gold-500 hover:to-gold-600 text-navy-900 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
                                <span class="text-sm font-bold">Scan</span>
                                <span class="text-[10px] text-navy-700">Sekarang</span>
                            </a>
                            <a href="{{ route('attendance.history') }}"
                                class="group flex flex-col items-center gap-2 p-4 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
                    ...
                    <div class="card p-4">
                        <div class="flex items-center gap-2 mb-3">
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-gold-400 to-gold-500 rounded-lg flex items-center justify-center">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-start gap-2">
                                <div
                                    class="w-5 h-5 bg-gold-100 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 rounded-full flex items-center justify-center text-[9px] font-bold flex-shrink-0">
                                    1</div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-amber-600 dark:text-amber-400 leading-relaxed">
                                    Jangan bagikan QR Code ini kepada orang lain. QR Code ini adalah identitas presensi Anda
                                    dan hanya boleh digunakan oleh Anda sendiri. Jika QR Code hilang atau disalahgunakan,
                                    segera hubungi admin untuk regenerate.
                                </p>
                            </div>
                        </div>
                    </div>
