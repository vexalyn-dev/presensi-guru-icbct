        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="code" required 
                       placeholder="Contoh: XA001, XIIPA1"
            ...
            <div>
                ...
                <input type="text" name="building" 
                       placeholder="Contoh: Gedung A, Blok C"
            ...
            <div>
                ...
                <select name="floor" 
                    ...
                    @for($i = 1; $i <= 10; $i++)
                    <option value="{{ $i }}" {{ old('floor', $classroom->floor) == $i ? 'selected' : '' }}>Lantai {{ $i }}</option>
                    @endfor
                </select>
            </div>
            ...
            <!-- Status -->
            <div>
                <label class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-700/30 rounded-xl border border-slate-200 dark:border-slate-700 cursor-pointer">
