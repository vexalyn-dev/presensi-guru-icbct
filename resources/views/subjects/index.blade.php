    ...
    <div class="fade-in space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-navy-800 dark:text-white tracking-tight">Mata Pelajaran</h1>
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola data mata pelajaran</p>
                </div>
            </div>
